    ...
    <Layout>
      ...
      >
        ...
        >
          ...
          <p style={{ color: "#666" }}>Last updated: May 29, 2025</p>
        </div>
        ...
        <div className="terms-content" style={{ lineHeight: "1.6" }}>
          ...
          <section style={{ marginBottom: "30px" }}>
            ...
            >
              ...
              <li>
                <strong>Company</strong> refers to Plixon Smart TVs, B/H, Angel
                Madras Cafe, M-167, 4, Akshar Marg, near Amin Marg, Gujarat
                Housing Board, Kotecha Nagar, Rajkot, Gujarat 360001.
              </li>
              <li>
          ...
          <section style={{ marginBottom: "30px" }}>
            ...
            >
              <li>
                By email:{" "}
                <a href="mailto:info@plixon.in" style={{ color: "#007bff" }}>
                  info@plixon.in
                </a>
              </li>
              <li>
              ...
              <li>
                By mail: B/H, Angel Madras Cafe, M-167, 4, Akshar Marg, near
                Amin Marg, Gujarat Housing Board, Kotecha Nagar, Rajkot, Gujarat
                360001
              </li>
            </ul>
          </section>
        ...
        {/* <div className="terms-footer" style={{ marginTop: '40px', textAlign: 'center' }}>
